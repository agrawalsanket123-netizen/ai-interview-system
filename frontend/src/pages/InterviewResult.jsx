...
const s = {
  ...
  feedbackBox: { background: 'rgba(124,106,191,0.06)', border: '1px solid rgba(124,106,191,0.2)', borderRadius: 'var(--radius-sm)', padding: '0.875rem 1rem', marginBottom: '0.75rem' },
