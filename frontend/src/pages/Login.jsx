...
const s = {
  ...
  left: {
    flex: 1, background: 'linear-gradient(135deg, #0d0d28 0%, #10102e 100%)',
  ...
  leftGlow: {
    ...
    background: 'radial-gradient(circle, rgba(139,167,245,0.1) 0%, transparent 65%)',
  },
  ...
  brandIcon: {
    ...
    display: 'flex', alignItems: 'center', justifyContent: 'center',
    fontSize: '0.75rem', fontWeight: 800, color: '#07071a', fontFamily: 'var(--font-display)',
  },
  ...
  error: {
    background: 'rgba(245,122,139,0.1)', border: '1px solid rgba(245,122,139,0.3)',
    borderRadius: 'var(--radius-sm)', padding: '0.75rem 1rem',
    color: 'var(--danger)', fontSize: '0.875rem', marginBottom: '1.5rem',
  },
  ...
  btn: {
    ...
    color: '#07071a', border: 'none', padding: '0.9rem',
