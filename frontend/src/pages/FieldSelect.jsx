...
const FIELDS = [
  ...
  { id: 'CyberSecurity', label: 'Cyber Security', desc: 'Encryption, firewalls, threat analysis, network security', icon: '🔒', color: 'rgba(91,141,239,0.1)', accent: 'var(--accent)', border: 'rgba(91,141,239,0.3)' },
  { id: 'SoftwareDevelopment', label: 'Software Development', desc: 'Agile, SOLID principles, CI/CD, design patterns, testing', icon: '💻', color: 'rgba(91,141,239,0.1)', accent: 'var(--accent)', border: 'rgba(91,141,239,0.3)' },
  { id: 'ArtificialIntelligence', label: 'Artificial Intelligence', desc: 'Neural networks, NLP, deep learning, LLMs, ethics', icon: '🧠', color: 'rgba(124,106,191,0.1)', accent: 'var(--accent2)', border: 'rgba(124,106,191,0.3)' },
]
  ...
  return (
    <main style={s.main} className="page-enter page-pad">
      <div style={s.header}>
        ...
        <p style={s.sub}>10 questions per field. Each answer scored 0–10 by AI with detailed feedback.</p>
      </div>
      <div style={s.grid}>
        {FIELDS.map((f, i) => (
